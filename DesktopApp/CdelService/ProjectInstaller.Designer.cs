namespace CdelService
{
	partial class ProjectInstaller
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.serviceInstallerMain.Description = "正保远程教育后台任务执行服务";
			this.serviceInstallerMain.DisplayName = "CdelService";
			this.serviceInstallerMain.ServiceName = "CdelService";
