...
namespace DesktopApp.Utils
{
    internal class WindowCommandHelper
    {
        ...
        public WindowCommandHelper(Window window) => _window = window;
        ...
        private void CanResizeWindow(object sender, CanExecuteRoutedEventArgs e) => e.CanExecute = _window.ResizeMode is ResizeMode.CanResize or ResizeMode.CanResizeWithGrip;

        private void CanMinimizeWindow(object sender, CanExecuteRoutedEventArgs e) => e.CanExecute = _window.ResizeMode != ResizeMode.NoResize;

        private void CloseWindow(object sender, ExecutedRoutedEventArgs e) => _window.Close();
